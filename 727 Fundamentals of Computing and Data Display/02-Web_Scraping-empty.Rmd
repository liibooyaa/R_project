...
```{r}
ndss <- html_nodes(url, xpath = '//*[contains(concat( " ", @class, " " ), concat( " ", "search-result-fact-list", " " ))] | //*[contains(concat( " ", @class, " " ), concat( " ", "search-result-grade", " " ))]')
```

Again, we extract the text from the results object.

```{r}
grades <- html_text(ndss)
head(grades)
